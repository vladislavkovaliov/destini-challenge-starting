...
class StoryBrain {
  ...
  String getStory() {
    return this._storyData[this.storyNumber].storyTitle;
  }

  String getChoice1() {
    return this._storyData[this.storyNumber].choice1;
  }

  String getChoice2() {
    return this._storyData[this.storyNumber].choice2;
  }
  ...
  bool buttonShouldBeVisible() {
    return [0,1,2].indexOf(this.storyNumber) != -1;
  }
}
